...
def fetch_data(ticker: str = "SPY", start_date: str = "2019-06-01", end_date: str = "2024-06-01"):
    # Fetch data
...
def main(train_model=True):
   ...
   # Parameters
    ...
    if train_model:
        ...
        torch.save(model.state_dict(), "nbeats_SPY.pth")
        ...
        model.load_state_dict(torch.load("nbeats_SPY.pth"))
        model.eval()
